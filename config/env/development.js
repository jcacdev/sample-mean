...
module.exports = {
  db: {
    ...
    // uri: 'mongodb://user-tester-1:flip4242@testclus01-g70wh.mongodb.net/fof?retryWrites=true&w=majority',
    uri: 'mongodb://user-tester-1:flip4242@testclus01-shard-00-00-g70wh.mongodb.net:27017/fof?ssl=true&replicaSet=TestClus01-shard-0&authSource=admin',
    options: {},
